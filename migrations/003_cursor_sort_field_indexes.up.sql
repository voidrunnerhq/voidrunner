...
CREATE INDEX IF NOT EXISTS idx_tasks_status_name_created_id
...
CREATE INDEX IF NOT EXISTS idx_tasks_updated_id
ON tasks(updated_at DESC, id DESC);

CREATE INDEX IF NOT EXISTS idx_tasks_name_created_id
ON tasks(name DESC, created_at DESC, id DESC);

-- Composite index for complex priority-based queries
CREATE INDEX IF NOT EXISTS idx_tasks_priority_status_user_created
...
CREATE INDEX IF NOT EXISTS idx_tasks_name_text_pattern
